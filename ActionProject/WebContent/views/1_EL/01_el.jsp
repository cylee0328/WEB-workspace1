...
<body>
	<h3>1. 기존방식대로 스크립틀릿과 표현식을 이용해서 각 영역에 담겨 있는 값을 뽑아서 화면에 출력</h3>
	<%
	...
	<p>
		...
		<%--
			teacher라는 키값에 접근했을때 밸류값이 Person 객체임.
	...
	<!-- 
		...
		현재 찾고잇는 scope범위 안에서 내가 찾고자하는 속성이 존재한다면 , 반복을 멈추도 해당 속성의 속성값을 출력함.
