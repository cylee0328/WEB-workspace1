...
<body>
	...
	<p>
		...
		JSP상에서 표현하고자 하는 값을 \${name }의 형식으료 표현해서 작성하는 것.
		
		javascript의 \${자바스크립트변수 }를 쓰고싶다면 페이지 지시어중 isELIgnored속성을 true로 변경해주면 됨.
	</p>
	
	<h3>1. EL 기본 구문</h3>
	<a href="/action/el.do">01.EL</a>
	...
	<!-- 
		* JSP를 이루는 구성인자
		...
		2. 지시어 : JSP페이지 정보에 대한 내용을 표현하다거나 또다른 페이지를 포함할 때 사용
		   EX) 지시어 (page 지시어, include 지시어 , taglib 지시어(라이브러리 추가시 사용)
		   
		3. JSP 액션태그 : XML 기술을 이용해서 기존 jsp문법을 확장하는 기술을 제공하는 태그 
