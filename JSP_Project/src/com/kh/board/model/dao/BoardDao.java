...
public class BoardDao {
	...
	public ArrayList<Board> selectList(Connection conn, PageInfo pi) {
		...
		try {
			...
			/*
			 * 시작과 종료 boardLimit이 10이라고 가정 currentPage 1을 요청시 ->1~10 currentPage 2를 요청시
			 * ->11~20 currentPage n을 요청시 -> 시작값 (currentPage-1) * boardLimit -1 ~ 종료값 : 시작값
			 * + boardLimit -1
			 * 
			 */
	...
	public int insertAttachment(Connection conn, Attachment at) {
		...
		try {
			...
			pstmt.setString(2, at.getChageName());
	...
	public Attachment selectAttachment(Connection conn, int boardNo) {
		...
		try {
			...
			if (rset.next()) {
				...
				at.setOrginName(rset.getString("ORIGIN_NAME"));
				at.setChageName(rset.getString("CHANGE_NAME"));
	...
	public int insertNewAttachment(Connection conn, Attachment at) {
		...
		try {
			...
			pstmt.setString(3, at.getChageName());
