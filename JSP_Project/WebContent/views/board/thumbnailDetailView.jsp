         ...
         <tr>
            ...
            <td colspan="3">
               ...
               <tr>
                  <td>대표사진</td>
                  <td colspan="3">
                       <img src="<%= contextPath + list.get(0).getFilePath() + list.get(0).getChageName() %>" width="500" height="300">
                  </td>
               </tr>
         ...
         <tr>
            ...
            <td colspan="3">
               <% for(int i= 1; i<= list.size() -1; i++) { %>
                     <img src="<%= contextPath + list.get(i).getFilePath() + list.get(i).getChageName() %> " width="200" height="150">
               <% } %>
            </td>
         </tr>
